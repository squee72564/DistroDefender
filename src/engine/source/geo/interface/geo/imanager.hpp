...
public:
     ...
     */
    virtual base::OptError addDb(std::string_view path, Type type) = 0;
     ...
     */
    virtual base::OptError removeDb(std::string_view path) = 0;
    ...
    remoteUpsertDb(std::string_view path, Type type, std::string_view dbUrl, std::string_view hashUrl) = 0;
