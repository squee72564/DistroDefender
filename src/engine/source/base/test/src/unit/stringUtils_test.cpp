...
TEST(splitMultiDelim, ThreeDelimiters)
{
    ...
    std::vector<std::string> expected = {"this",
                                         ...
                                         "the",
                                         "result"};
    std::vector<std::string> result = base::utils::string::splitMultiDelim(input,
                                                                      base::utils::string::Delimiter('-', true),
                                                                      base::utils::string::Delimiter(',', false),
                                                                      base::utils::string::Delimiter(' ', false));
...
TEST(splitMultiDelim, SingleDelimiterAndEmptyAtEnd)
{
    ...
    std::vector<std::string> result =
        base::utils::string::splitMultiDelim(input, base::utils::string::Delimiter('/', false));
    ASSERT_EQ(result, expected);
}
